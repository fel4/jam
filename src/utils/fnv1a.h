...
typedef uintptr_t jam_hash_value_t; 
...
jam_result_t jam_fnv1a_hash_add(jam_fnv1a_hash_t*, const char*, size_t, jam_hash_value_t*);
jam_result_t jam_fnv1a_hash_get(jam_fnv1a_hash_t*, jam_hash_value_t*);
